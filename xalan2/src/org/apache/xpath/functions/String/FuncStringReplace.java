 ...
 *
 */
public class FuncStringReplace extends Function3Args
{
  ...
  public XObject execute(XPathContext xctxt) throws javax.xml.transform.TransformerException
  {
	 ...
	 String replacement = m_arg2.execute(xctxt).str();
	 return  new XString(input.replaceAll(pattern, replacement));
  }
}
