...
public class ExtensionFunctionResolver
{
    ...
    public static final String EXPR1 = "math:sin(3)";
    ...
    public static final String EXPR2 = "java:XPathAPI.ExtensionTest.test(/doc/num)";
    
    public static final String EXPR3 = "str:endswith(/doc/num,'Бъ')";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        InputSource context = new InputSource("foo.xml");
        ...
        Object list = xpath.evaluate(EXPR3, context, XPathConstants.NODESET);
        
        
        NodeList nodeList=(NodeList)list;
        
        System.out.println(EXPR3 + " = " + nodeList.getLength());
